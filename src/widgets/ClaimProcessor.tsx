...
import { Camera, FileText, UploadCloud, Search, MapPin, Download, CheckCircle, AlertTriangle, FileArchive, Languages, Loader2, ShieldCheck, LogIn } from 'lucide-react';
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      if(aiData.success) {
         ...
         await saveClaimToDatabase({ ...aiData.data, uid: user?.uid || 'anonymous' });
      } else {
          ...
          {!result ? (
            ...
            <div className="flex flex-col gap-6" aria-live="polite">
              ...
              <button 
                ...
                className="flex items-center justify-center w-full py-4 px-6 rounded-xl bg-emerald-600 text-white font-bold text-lg hover:bg-emerald-50 transition-all shadow-xl shadow-emerald-500/20"
